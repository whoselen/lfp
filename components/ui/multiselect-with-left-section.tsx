...
const MultipleSelectorWithLeftSection = React.forwardRef<
  MultipleSelectorRef,
...
MultipleSelectorWithLeftSection.displayName = "MultipleSelectorWithLeftSection";
export default MultipleSelectorWithLeftSection;
